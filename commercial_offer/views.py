...
def result(request):
    ...
    time_1 = int(newInterior.time_of_visualization() + newInterior.time_of_blueprints() + 2)
    time_2 = int(newInterior_2.time_of_visualization() + newInterior_2.time_of_blueprints() + 2)
    time_3 = int(newInterior_3.time_of_visualization() + newInterior_3.time_of_blueprints() + 2)
