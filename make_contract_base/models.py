...
class ContractBase(models.Model):
    ...
    price = models.FloatField(verbose_name="цена", null=True, default=100)
    ...
    total_cost = models.FloatField(verbose_name="цена", null=True, default=10000)
    adressofobject = models.CharField(max_length=255, verbose_name="Адрес объекта", null=True,
                                      default="350010,г. Краснодар, ул. Зиповская, д. 5 Литера Х, офис 28")
    townobject = models.CharField(max_length=255, verbose_name="Город", null=True, default="Москва")
    telephonenum = models.CharField(max_length=15, verbose_name="телефон", null=True, default="+79780740854")
    customer_firm = models.CharField(max_length=50, verbose_name="Название организации", null=True,
    ...
    organization_adress = models.CharField(max_length=250, verbose_name="Адрес организации", null=True,
                                           default="г. Краснодарпу")
    customer_legal_basis = models.CharField(max_length=250, verbose_name="Основание", null=True,
    ...
    ogrn = models.BigIntegerField(verbose_name="КПП", null=True, default=1026605606620)
