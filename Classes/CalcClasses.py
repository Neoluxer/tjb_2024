...
class ProjectPrice:
    ...
    PROFIT_NORM_PER_M = 280_000  # Норма прибыли в месяц

    OVERHEAD_PER_M = 13_939 + 341  # Расходы без УСН налога (6%) и без Аренды офиса
    wage_of_designer = 800  # Гонорар дизайнера за квадрат
    ...
    def __init__(self, square, spaces, typeof: int, content: list, designers=DESIGNERS, draftsmen=DRAFTSMENS,
                 profit_norm_perm: int = PROFIT_NORM_PER_M, wage_of_designer: int = 0, wage_of_draftsmen: int = 0,
